  ...
  <div class="columns-container" :class="{ 'columns-container--sizes': !logo }">
    <div class="flex gap-6 h-max">
      <div v-for="column in columns" :key="column.name" class="flex flex-col">
        ...
        <task-card
          ...
          :key="title"
          :how-many-completed="returnNumberOfCompletedSubtasks(subtasks)"
          :how-many-subtasks="subtasks.length"
          :title="title"
          :is-clicked-task="clickedTitle === title"
          :show-task-details="(e: Event) => changeClickedTask(e)"
        />
      </div>
    ...
    <transition name="dialog">
      <confirmation-dialog
        ...
        element-to-delete="task"
        element-name="Research pricing points of various competitors and trial different business models"
