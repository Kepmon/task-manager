<template>
  <h1
    class="max-[480px]:mt-4 mb-8 text-xlFluid text-center font-bold tracking-wider"
  >
    Privacy Policy
  </h1>
  ...
  <div class="text-center text-baseFluid">
    <p class="font-bold italic text-lgFluid">
      ...
      want you to know how we collect, use, and share your personal information.
    </p>

    <h2 class="font-bold">Information We Collect</h2>
    <p>
      We collect personal information when you sign up. The personal information
      we collect may include your name, email address, and any other information
      you provide to us.
    </p>
    ...
    <ul>
      <li class="flex items-center justify-center">
        <right-arrow />
        Send you newsletters, updates, and other information about our products
        and services
      </li>
      <li class="flex items-center justify-center">
        <right-arrow />
    ...
    <h2 class="font-bold">How We Share Your Information</h2>
    <p>
      We do not share your personal information with third parties without your
      consent, except as required by law or as necessary to protect our legal
      rights.
    </p>
    ...
    <p>
      ...
      unauthorized access,use, or disclosure. However, no data transmission over
